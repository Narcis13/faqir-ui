...
//   controllers: 19 recipe factories → accordion, alert-dialog, combobox, command-palette, date-picker, dialog, drawer, dropdown, pagination, popover, qr-code, select-custom, sheet, sidebar, slider, table, tabs, toast, tooltip
