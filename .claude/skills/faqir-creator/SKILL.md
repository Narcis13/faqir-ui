...
**28 Recipes (CSS + JS controller):** accordion, alert-dialog, barcode, calendar, combobox, command-palette, context-menu, date-picker, dialog, drawer, dropdown, file-upload, input-otp, menubar, pagination, popover, qr-code, select-custom, sheet, sidebar, slider, table, tabs, tag-input, toast, toggle-group, tooltip, tree-view
...
- [references/recipes.md](references/recipes.md) — 28 recipes
